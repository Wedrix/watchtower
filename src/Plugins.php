...
function Plugins(
    ...
    return $instances[$directory][$cacheDirectory][$optimize ? 'true' : 'false'] ??= new class(directory: $directory, cacheDirectory: $cacheDirectory, optimize: $optimize) implements Plugins
    {
